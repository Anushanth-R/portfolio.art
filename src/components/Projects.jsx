    ...
    return (
        <section id="projects" className="min-h-[calc(100dvh-40px)] px-3 py-6 flex flex-col justify-center scroll-mt-[40px]">
            ...
            <div className="flex flex-wrap gap-5 items-center justify-center">
                ...
                <div className="border-2 border-[var(--primary-color)] max-w-[300px] p-3 md:p-4 rounded-2xl shadow-lg hover:shadow-[0_0_15px_var(--primary-color)] transition-shadow duration-300">
